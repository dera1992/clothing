...
(function($) {
	...
	*===================================*/
    ...
    var min_price = getUrlParam('price_min','Empty');
    var max_price = getUrlParam('price_max','Empty');
    if (min_price === "Empty") {
        $('#price-range').slider({
            range: true,
            min: 0,
            ...
            slide: function( event, ui ) {
                $('#flt_price').val( 'Price: ' + '₦' + ui.values[ 0 ] + ' - ₦' + ui.values[ 1 ] );
            },
    ...
    $('#flt_price').html('₦' + $('#price-range').slider( 'values', 0 ) +
